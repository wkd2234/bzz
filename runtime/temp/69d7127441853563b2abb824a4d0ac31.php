<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\Apache24\htdocs\bzz\public/../application/index\view\picture\ipad.html";i:1479966035;}*/ ?>
...
<div class="container"><!--外界边框big-->
    ...
    <div class="neiye">
        ...
        <div class="neiye-img2sm">
            <div class="neiye-img2sm-up1">
                <?php if($pre['id']): ?>
                <a href="<?php echo url('/picture/ipad/id/'.$pre['id']); ?>">
                    <div class="ny-up-con">
            ...
            <div class="neiye-img2sm-con">
                <ul id="cc">
                    ...
                    <li>
                    <?php endif; ?>
                        <div class="ny-con-img"><img src="<?php echo $vo['pic']; ?>"></div>
            ...
            <div class="neiye-img2sm-up2">
                <?php if($next['id']): ?>
                <a href="<?php echo url('/picture/ipad/id/'.$next['id']); ?>">
                    <div class="ny-up-con">
                        <div class="ny-up-con1">
    ...
    <div class="neiye-bottom">
        ...
        <div class="ipad-box" style="<?php echo !empty($i+1) && $i+1!=1?'margin-left:40px':'margin-left:0px'; ?>">
